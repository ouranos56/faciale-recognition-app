...
export default function ClientContent() {
  ...
  return (
    <>
      <div className=" w-[50vw] max-md:w-[85vw] textamber-400/80 text-[18px] text-center bg-amber-400/15 backdrop-blur-[2px] rounded-xl p-2 " >La reconnaissance d’image est temporairement indisponible pour des raisons financières liées au paiement de l’hébergeur.</div>
