            ...
            >
                <div className="modal-box">
                    ...
                    <div className="font-light py-4 uploadedimagecard h-[60vh] text-xl text-justify hyphens-auto">
                        ...
                        <div className="my-3.25 font-normal">WETOHOSSOU Lucien <a href="https://github.com/ouranos56/faciale-recognition-app.git"  className="underline text-blue-200/80" >GitHub: ouranos56</a></div>
