...
export default function HomeClient() {
  ...
  useEffect(() => {
    setTimeout(() => {
      setLoading(false);
    }, 500); // Simule un chargement de 0.5 seconde et laisse le temps pour importer les ressources
  }, []);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 ">
            ...
            >
              <div className=" w-20 h-20">
                <Image
                  src="/assets/wired-outline-3099-portrait-photo-hover-pinch.gif"
                  alt="Aperçu de l'image"
                  unoptimized
                  loading="lazy"
                  width={80}
            ...
            >
              <div className=" w-20 h-20">
                <Image
                  src="/assets/doodle-outline-692-document-upload-hover-pinch.gif"
                  alt="Aperçu de l'image"
                  unoptimized
                  loading="lazy"
                  width={80}
            ...
            >
              <div className=" w-20 h-20">
                <Image
                  src="/assets/wired-outline-1315-computer-mouse-hover-pinch.gif"
                  alt="Aperçu de l'image"
                  unoptimized
                  loading="lazy"
                  width={80}
            ...
            >
              <div className=" w-20 h-18">
                <Image
                  src="/assets/wired-outline-1122-thumb-down-morph-up.gif"
                  alt="Aperçu de l'image"
                  unoptimized
                  loading="lazy"
                  width={80}
